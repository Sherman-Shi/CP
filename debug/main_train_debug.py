...
import sys
sys.path.append("/home/zhenpeng/桌面/brainstorm/CP")
...
def load_config(config_path="/home/zhenpeng/桌面/brainstorm/CP/configs/config_debug.yaml"):
...
def main():
    ...
    #dynamic
    dynamic_dataset = RSADataset(config)    
